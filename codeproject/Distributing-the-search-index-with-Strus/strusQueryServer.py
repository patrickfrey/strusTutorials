...
myport = 7183
# Strus message processor:
strusctx = strus.Context()
strusmsg = strusctx.createStatisticsProcessor()
...
application = tornado.web.Application([
    ...
    # /query in the URL triggers the handler for querying statistics:
